...
Creating database schema for: sqlite:////Users/andrwj/.local/share/chatgpt-wrapper/profiles/default/storage.db
...
Enter username (no spaces): andrwj
Enter email: user-id@....
